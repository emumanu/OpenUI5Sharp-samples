        ...
        methods: {
            onInit: function () {
                ...
                oRouter.attachBypassed(function (oEvent, oData) {
                    var $t, $t1, $t2;
                    var sHash = UI5.Extensions.BaseExtensions.getParameterFor(System.Object, System.String, oEvent, ($t = { ntype: 38, t: System.Object, n: "p" }, ($t2 = ($t1 = {"td":System.Object,"a":2,"n":"hash","t":4,"rt":System.String,"sn":"hash"}, { ntype: 23, t: $t1.rt, expression: $t, member: $t1 }), { ntype: 18, t: Function, rt: $t2.t, body: $t2, p: Bridge.toList([$t]) })));
                ...
                oRouter.attachRouteMatched(function (oEvent, oData) {
                    var $t, $t1, $t2;
                    var sRouteName = UI5.Extensions.BaseExtensions.getParameterFor(System.Object, System.String, oEvent, ($t = { ntype: 38, t: System.Object, n: "p" }, ($t2 = ($t1 = {"td":System.Object,"a":2,"n":"name","t":4,"rt":System.String,"sn":"name"}, { ntype: 23, t: $t1.rt, expression: $t, member: $t1 }), { ntype: 18, t: Function, rt: $t2.t, body: $t2, p: Bridge.toList([$t]) })));

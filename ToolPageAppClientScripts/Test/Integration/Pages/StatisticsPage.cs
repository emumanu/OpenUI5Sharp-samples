...
namespace ClientScripts.Test.Integration
{
    ...
    public class OnTheStatisticsPage : BaseIntegrationPage
    {
        ...
        [OpaAction]
        public virtual es5.Promise<object> iPressTheRefreshButton()
        {
        ...
        [OpaAssertion]
        public virtual es5.Promise<object> iShouldSeeTheStatisticsView()
        {
            return this.waitFor(new WaitForOptions() {
                viewName = sViewName,
        ...
        [OpaAssertion]
        public virtual es5.Promise<object> iShouldSeeTheBusyIndicator()
        {
            return this.waitFor(new WaitForOptions() {
        ...
        [OpaAssertion]
        public virtual es5.Promise<object> iShouldSeeTheCharts()
        {

...
namespace ClientScripts.Test.Integration
{
    ...
    public class OnTheSettingsPage : BaseIntegrationPage
    {
        ...
        [OpaAction]
        public virtual es5.Promise<object> iPressTheOrderSettingsItem()
        {
        ...
        [OpaAction]
        public virtual es5.Promise<object> iPressTheSaveButton()
        {
            return this.waitFor(new WaitForOptions() {
                id = "save",
                viewNamespace = "manu.toolpageapp.fv.view.settings",
        ...
        [OpaAction]
        public virtual es5.Promise<object> iPressTheCancelButton()
        {
            return this.waitFor(new WaitForOptions() {
                id = "cancel",
                viewNamespace = "manu.toolpageapp.fv.view.settings",
        ...
        [OpaAssertion]
        public virtual es5.Promise<object> iShouldSeeMasterSettingsView()
        {
            return this.waitFor(new WaitForOptions() {
                viewNamespace = "manu.toolpageapp.fv.view.settings",
                viewName = sViewName1,
        ...
        [OpaAssertion]
        public virtual es5.Promise<object> iShouldSeeDetailSettingsView()
        {
            return this.waitFor(new WaitForOptions() {
				viewNamespace = "manu.toolpageapp.fv.view.settings",
				viewName = sViewName2,

    ...
    Bridge.define("sap.ui.demo.walkthrough.controller.Detail", {
        ...
        methods: {
            ...
            _onObjectMatched: function (oEvent, oData) {
                ...
                this.getView().bindElement({ path: decodeURIComponent(Bridge.cast(UI5.Extensions.BaseExtensions.getParameterFor(System.Object, System.Object, oEvent, ($t = { ntype: 38, t: System.Object, n: "p" }, ($t2 = ($t1 = {"td":System.Object,"a":2,"n":"arguments","t":4,"rt":System.Object,"sn":"arguments"}, { ntype: 23, t: $t1.rt, expression: $t, member: $t1 }), { ntype: 18, t: Function, rt: $t2.t, body: $t2, p: Bridge.toList([$t]) }))).invoicePath, System.String)), model: "invoice" });
            },

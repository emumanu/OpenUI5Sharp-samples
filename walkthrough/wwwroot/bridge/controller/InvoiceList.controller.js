    ...
    Bridge.define("sap.ui.demo.walkthrough.controller.InvoiceList", {
        ...
        methods: {
            ...
            onFilterInvoices: function (oEvent, oData) {
                ...
                var sQuery = UI5.Extensions.BaseExtensions.getParameterFor(System.Object, System.String, oEvent, ($t = { ntype: 38, t: System.Object, n: "p" }, ($t2 = ($t1 = {"td":System.Object,"a":2,"n":"query","t":4,"rt":System.String,"sn":"query"}, { ntype: 23, t: $t1.rt, expression: $t, member: $t1 }), { ntype: 18, t: Function, rt: $t2.t, body: $t2, p: Bridge.toList([$t]) })));
                if (sQuery != null) {

Bridge.assembly("ClientScripts", function ($asm, globals) {
    ...
    Bridge.define("ClientScripts.Test.Integration.OnTheStatisticsPage", {
        ...
        $metadata : function () { return {"att":1048577,"a":2,"m":[{"a":2,"n":".ctor","t":1,"p":[sap.ui.test.Opa5],"pi":[{"n":"Opa5","pt":sap.ui.test.Opa5,"ps":0}],"sn":"ctor"},{"a":2,"n":"RequireScript","is":true,"t":8,"sn":"RequireScript","rt":System.Void},{"at":[new UI5.Tests.OpaActionAttribute()],"v":true,"a":2,"n":"iPressTheRefreshButton","t":8,"sn":"iPressTheRefreshButton","rt":Bridge.virtualc("Promise")},{"at":[new UI5.Tests.OpaAssertionAttribute()],"v":true,"a":2,"n":"iShouldSeeTheBusyIndicator","t":8,"sn":"iShouldSeeTheBusyIndicator","rt":Bridge.virtualc("Promise")},{"at":[new UI5.Tests.OpaAssertionAttribute()],"v":true,"a":2,"n":"iShouldSeeTheCharts","t":8,"sn":"iShouldSeeTheCharts","rt":Bridge.virtualc("Promise")},{"at":[new UI5.Tests.OpaAssertionAttribute()],"v":true,"a":2,"n":"iShouldSeeTheStatisticsView","t":8,"sn":"iShouldSeeTheStatisticsView","rt":Bridge.virtualc("Promise")},{"a":2,"n":"sChartViewName","t":4,"rt":System.String,"sn":"sChartViewName"},{"a":2,"n":"sViewName","t":4,"rt":System.String,"sn":"sViewName"}]}; },
        fields: {
            sViewName: null,
            sChartViewName: null
        },

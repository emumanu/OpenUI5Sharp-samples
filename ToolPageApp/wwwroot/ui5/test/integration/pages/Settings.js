Bridge.assembly("ClientScripts", function ($asm, globals) {
    ...
    Bridge.define("ClientScripts.Test.Integration.OnTheSettingsPage", {
        ...
        $metadata : function () { return {"att":1048577,"a":2,"m":[{"a":2,"n":".ctor","t":1,"p":[sap.ui.test.Opa5],"pi":[{"n":"Opa5","pt":sap.ui.test.Opa5,"ps":0}],"sn":"ctor"},{"a":2,"n":"RequireScript","is":true,"t":8,"sn":"RequireScript","rt":System.Void},{"at":[new UI5.Tests.OpaActionAttribute()],"v":true,"a":2,"n":"iPressTheCancelButton","t":8,"sn":"iPressTheCancelButton","rt":Bridge.virtualc("Promise")},{"at":[new UI5.Tests.OpaActionAttribute()],"v":true,"a":2,"n":"iPressTheOrderSettingsItem","t":8,"sn":"iPressTheOrderSettingsItem","rt":Bridge.virtualc("Promise")},{"at":[new UI5.Tests.OpaActionAttribute()],"v":true,"a":2,"n":"iPressTheSaveButton","t":8,"sn":"iPressTheSaveButton","rt":Bridge.virtualc("Promise")},{"at":[new UI5.Tests.OpaAssertionAttribute()],"v":true,"a":2,"n":"iShouldSeeDetailSettingsView","t":8,"sn":"iShouldSeeDetailSettingsView","rt":Bridge.virtualc("Promise")},{"at":[new UI5.Tests.OpaAssertionAttribute()],"v":true,"a":2,"n":"iShouldSeeMasterSettingsView","t":8,"sn":"iShouldSeeMasterSettingsView","rt":Bridge.virtualc("Promise")},{"at":[new UI5.Tests.OpaAssertionAttribute()],"v":true,"a":2,"n":"iShouldSeeMessageToast","t":8,"sn":"iShouldSeeMessageToast","rt":Bridge.virtualc("Promise")},{"a":2,"n":"sViewName1","t":4,"rt":System.String,"sn":"sViewName1"},{"a":2,"n":"sViewName2","t":4,"rt":System.String,"sn":"sViewName2"}]}; },
        fields: {
            sViewName1: null,
            sViewName2: null
        },

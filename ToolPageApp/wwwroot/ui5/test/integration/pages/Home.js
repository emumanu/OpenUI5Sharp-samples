Bridge.assembly("ClientScripts", function ($asm, globals) {
    ...
    Bridge.define("ClientScripts.Test.Integration.OnTheHomePage", {
        ...
        $metadata : function () { return {"att":1048577,"a":2,"m":[{"a":2,"n":".ctor","t":1,"p":[sap.ui.test.Opa5],"pi":[{"n":"Opa5","pt":sap.ui.test.Opa5,"ps":0}],"sn":"ctor"},{"a":2,"n":"RequireScript","is":true,"t":8,"sn":"RequireScript","rt":System.Void},{"at":[new UI5.Tests.OpaAssertionAttribute()],"v":true,"a":2,"n":"iShouldSeeTheHomeView","t":8,"sn":"iShouldSeeTheHomeView","rt":Bridge.virtualc("Promise")},{"a":2,"n":"sViewName","t":4,"rt":System.String,"sn":"sViewName"}]}; },
        fields: {
            sViewName: null
        },
        ctors: {

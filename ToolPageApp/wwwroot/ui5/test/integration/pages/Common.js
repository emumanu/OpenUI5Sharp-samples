...
sap.ui.define(System.Array.init(["sap/ui/test/Opa5"], System.String), function (Opa5) {
    var newObj = UI5.Glue.CreateRawClassObject(manu.toolpageapp.fv.test.integration.pages.Common);
    return Opa5.extend("manu.toolpageapp.fv.test.integration.pages.Common", newObj);
});

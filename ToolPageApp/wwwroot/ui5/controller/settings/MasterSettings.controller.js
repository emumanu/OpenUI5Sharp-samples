    ...
    Bridge.define("manu.toolpageapp.fv.controller.settings.MasterSettings", {
        ...
        methods: {
            ...
            onMasterPressed: function (oEvent, oData) {
                ...
                UI5.Extensions.ModelExtensions.setPropertyFor$4(System.Object, System.Boolean, oContext.getModel(), ($t = { ntype: 38, t: System.Object, n: "p" }, ($t2 = ($t1 = {"td":System.Object,"a":2,"n":"selected","t":16,"rt":System.Boolean,"g":{"td":System.Object,"a":2,"n":"get_selected","t":8,"rt":System.Boolean,"fg":"selected","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},"s":{"td":System.Object,"a":2,"n":"set_selected","t":8,"p":[System.Boolean],"rt":System.Void,"fs":"selected"},"fn":"selected"}, { ntype: 23, t: $t1.rt, expression: $t, member: $t1 }), { ntype: 18, t: Function, rt: $t2.t, body: $t2, p: Bridge.toList([$t]) })), true, oContext, false);
                var sSelectedMasterElement = sapuimodelContextTypedExtensions.getPropertyFor(System.Object, System.String, oContext, ($t3 = { ntype: 38, t: System.Object, n: "p" }, ($t5 = ($t4 = {"td":System.Object,"a":2,"n":"title","t":16,"rt":System.String,"g":{"td":System.Object,"a":2,"n":"get_title","t":8,"rt":System.String,"fg":"title"},"s":{"td":System.Object,"a":2,"n":"set_title","t":8,"p":[System.String],"rt":System.Void,"fs":"title"},"fn":"title"}, { ntype: 23, t: $t4.rt, expression: $t3, member: $t4 }), { ntype: 18, t: Function, rt: $t5.t, body: $t5, p: Bridge.toList([$t3]) })), false);
                var sKey = sapuimodelContextTypedExtensions.getPropertyFor(System.Object, System.String, oContext, ($t6 = { ntype: 38, t: System.Object, n: "p" }, ($t8 = ($t7 = {"td":System.Object,"a":2,"n":"key","t":16,"rt":System.String,"g":{"td":System.Object,"a":2,"n":"get_key","t":8,"rt":System.String,"fg":"key"},"s":{"td":System.Object,"a":2,"n":"set_key","t":8,"p":[System.String],"rt":System.Void,"fs":"key"},"fn":"key"}, { ntype: 23, t: $t7.rt, expression: $t6, member: $t7 }), { ntype: 18, t: Function, rt: $t8.t, body: $t8, p: Bridge.toList([$t6]) })), false);
...
sap.ui.define(System.Array.init(["sap/m/MessageToast", "sap/ui/model/json/JSONModel"], System.String), function (Formatter) {
    ...
    return manu.toolpageapp.fv.controller.BaseController.extend("manu.toolpageapp.fv.controller.settings.MasterSettings", newObj);
});
